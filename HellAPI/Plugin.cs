...
namespace Hell
{
	...
	public abstract class Plugin
	{
		...
		internal static extern IntPtr m_HookEventObjParam(string name, MirandaHookObjParam hookProc, IntPtr pObject,
			IntPtr lParam);
		...
		internal static extern IntPtr m_CreateServiceFunctionObjParam(string name, MirandaServiceObjParam serviceProc,
			IntPtr pObject, IntPtr lParam);

		protected IntPtr CreateServiceFunctionObjParam(string name, MirandaServiceObjParam serviceProc, IntPtr pObject,
			IntPtr lParam)
		{
